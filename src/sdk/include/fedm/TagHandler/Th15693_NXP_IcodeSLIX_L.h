...
#ifndef FEDM_TH_ISO15693_NXP_ICODESLIX_L_H
#define FEDM_TH_ISO15693_NXP_ICODESLIX_L_H
...
class FEDM_CLASS_DEF ThIso15693_NXP_IcodeSLIX_L : public ThIso15693_NXP_IcodeSLI_L
{
...
public:
	...
	virtual ~ThIso15693_NXP_IcodeSLIX_L();

protected:
	ThIso15693_NXP_IcodeSLIX_L(Internal::ReaderBase *readerBase, const TagItem & tagItem = TagItem());

}; // end of class ThIso15693_NXP_ICODESLIX_L

}; // end of namespace TagHandler
}; // end of namespace FEDM

#endif // FEDM_TH_ISO15693_NXP_ICODESLIX_L_H
