...
#ifndef FEDM_FUNIT_HF_ANTENNA_STATIC_H
#define FEDM_FUNIT_HF_ANTENNA_STATIC_H
...
/// @brief FUNCTION-UNIT element class HF static antenna
///
/// A static antenna cannot be tunned
class FEDM_FUNIT_CLASS_DEF FunitHfAntStatic : public FunitElement
{
...
private:
	FunitHfAntStatic(size_t parentChannel, FunitElement *parent = nullptr);
	~FunitHfAntStatic();
...
#endif // FEDM_FUNIT_HF_ANTENNA_STATIC_H
